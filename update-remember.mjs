// update-remember.mjs — adds "Remember me" one-tap check-in for students
// Usage: node update-remember.mjs
import { mkdirSync, writeFileSync } from 'node:fs';
import { dirname, join } from 'node:path';

const files = {

'src/utils/remember.js': `
...
/* ---------- Remember me: one-tap quick check-in ---------- */
...
console.log('Hard-refresh the browser (Ctrl+Shift+R), then follow the test checklist.');